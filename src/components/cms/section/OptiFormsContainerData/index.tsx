...
import {
   ...
   type OptiFormsContainerDataDataFragment,
} from "@/gql/graphql";
...
> = ({ data, editProps, children }) => {
   ...
   return (
      <CmsEditable
         className="w-full border-y border-y-solid border-y-slate-900 py-2 mb-4"
         {...editProps}
      >
...
OptiFormsContainerDataSection.displayName =
   "Form Container (Section/OptiFormsContainerData)";
OptiFormsContainerDataSection.getDataFragment = () => [
